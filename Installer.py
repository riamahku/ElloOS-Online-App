...
print("Downloading ElloOSBootsettings...")
...
print("Downloading Factory Reset...")
...
print("Downloading bootloader V.1 ...")
...
print("Downloading fastboot-extensions...")
